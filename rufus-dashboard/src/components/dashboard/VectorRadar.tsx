...
export default function VectorRadar({ scores, category = "other", brand = "Your Product" }: VectorRadarProps) {
  const [activeNode, setActiveNode] = useState<{ title: string; score: string; color: string; desc: string } | null>(null);
  ...
  const getWedgePath = (cx: number, cy: number, radius: number, rotationAngle: number) => {
  ...
  return (
    <div style={{ 
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "14px", borderBottom: "1px solid rgba(0, 245, 255, 0.08)", paddingBottom: "10px" }}>
        ...
        <div style={{ fontFamily: "var(--font-mono), monospace", fontSize: "0.65rem", color: "#64748b", background: "rgba(0, 245, 255, 0.04)", padding: "2px 8px", borderRadius: "4px", border: "1px solid rgba(0, 245, 255, 0.08)" }}>
      ...
      >
        {activeNode ? (
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: "16px", alignItems: "center" }}>
            <div>
              <div style={{ fontFamily: "var(--font-display), sans-serif", fontSize: "0.75rem", color: "#00f5ff", letterSpacing: "0.05em", marginBottom: "2px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "3px", borderLeft: "1px solid rgba(255,255,255,0.06)", paddingLeft: "16px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: "0.68rem", fontFamily: "var(--font-mono), monospace" }}>
      ...
      <div style={{ position: "relative", width: "100%", overflow: "hidden" }}>
        ...
        >
          ...
          <text x={cx + 4} y={cy - maxR + 9} fill="#475569" fontSize="6.5" fontFamily="var(--font-mono), monospace">100% DRIFT</text>

          <circle cx={cx} cy={cy} r={(maxR + minR) / 2} fill="none" stroke="rgba(0, 245, 255, 0.04)" strokeWidth="1" strokeDasharray="3,6" />
          <text x={cx + 4} y={cy - (maxR + minR)/2 + 9} fill="#475569" fontSize="6.5" fontFamily="var(--font-mono), monospace">50% SIMILARITY</text>

          <circle cx={cx} cy={cy} r={minR} fill="none" stroke="rgba(0, 245, 255, 0.12)" strokeWidth="1.2" />
          <text x={cx + 4} y={cy - minR + 9} fill="#475569" fontSize="6.5" fontFamily="var(--font-mono), monospace">0% DRIFT (TIGHT)</text>
          ...
          {showCompetitors && (
            <g style={{ transition: "opacity 0.4s ease" }}>
              ...
              >
                ...
                <text x={comp1.x + 8} y={comp1.y + 3} fill="#475569" fontSize="7.5" fontWeight="bold" fontFamily="var(--font-mono), monospace">COMP_ASIN_A</text>
              </g>
              ...
              >
                ...
                <text x={comp2.x + 8} y={comp2.y + 3} fill="#475569" fontSize="7.5" fontWeight="bold" fontFamily="var(--font-mono), monospace">COMP_ASIN_B</text>
              </g>
            </g>
          )}
          ...
          >
            ...
            <text x={cx} y={cy + 34} fill="#00f5ff" fontSize="8" fontWeight="bold" fontFamily="var(--font-mono), monospace" letterSpacing="0.05em" textAnchor="middle">
          ...
          {/* Top-Left: Intent */}
          <g>
            <text x={pIntentLabel.x - 8} y={pIntentLabel.y - 4} textAnchor="end" fontSize="9" fontFamily="var(--font-display), sans-serif" letterSpacing="0.02em">
              <tspan fill="#e2e8f0" fontWeight="700">INTENT ALIGNMENT </tspan>
              <tspan fill={colorIntent} fontFamily="var(--font-mono), monospace" fontWeight="bold">[{sIntent}/25]</tspan>
            </text>
          ...
          {/* Top-Right: Attribute */}
          <g>
            <text x={pAttributeLabel.x + 8} y={pAttributeLabel.y - 4} textAnchor="start" fontSize="9" fontFamily="var(--font-display), sans-serif" letterSpacing="0.02em">
              <tspan fill="#e2e8f0" fontWeight="700">ATTRIBUTE DENSITY </tspan>
              <tspan fill={colorAttribute} fontFamily="var(--font-mono), monospace" fontWeight="bold">[{sAttribute}/25]</tspan>
            </text>
          ...
          <g>
            <text x={pReadabilityLabel.x + 8} y={pReadabilityLabel.y + 11} textAnchor="start" fontSize="9" fontFamily="var(--font-display), sans-serif" letterSpacing="0.02em">
              <tspan fill="#e2e8f0" fontWeight="700">READABILITY </tspan>
              <tspan fill={colorReadability} fontFamily="var(--font-mono), monospace" fontWeight="bold">[{sReadability}/25]</tspan>
            </text>
          ...
          {/* Bottom-Left: QA */}
          <g>
            <text x={pQALabel.x - 8} y={pQALabel.y + 11} textAnchor="end" fontSize="9" fontFamily="var(--font-display), sans-serif" letterSpacing="0.02em">
              <tspan fill="#e2e8f0" fontWeight="700">Q&A COVERAGE </tspan>
              <tspan fill={colorQA} fontFamily="var(--font-mono), monospace" fontWeight="bold">[{sQA}/25]</tspan>
            </text>
